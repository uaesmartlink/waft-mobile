...
Future _preInitializations() async {
  try {
    ...
    DataHelper.user = await UserConfig.getUser();
    languageCode = await Translation.currentLanguageCode;
    ...
    return Scaffold(
      body: SizedBox(
        ...
        child: Column(
          ...
          children: [
            Text(
              LanguageKey.pleaseRestartTheApp.tr,
            ...
            ElevatedButton(
                ...
                child: Text(LanguageKey.restart.tr))
          ],
        ),
      ),
    );
